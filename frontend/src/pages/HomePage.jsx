        ...
        <div className="relative grid items-end gap-7 lg:grid-cols-[1.05fr_0.82fr] lg:gap-9">
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <button
                className="rounded-xl border border-transparent bg-linear-to-b from-[#1e88ff] to-[#0a67dd] px-5 py-3 text-[0.9rem] font-bold tracking-[0.01em] text-white shadow-[0_12px_24px_rgba(10,103,221,0.34)] transition duration-200 hover:-translate-y-0.5 hover:saturate-105 hover:shadow-[0_16px_28px_rgba(10,103,221,0.4)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(15,123,255,0.25)] focus-visible:ring-offset-2 focus-visible:ring-offset-transparent cursor-pointer"
